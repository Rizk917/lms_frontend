...
export default function AddStudents() {
  ...
  const studentAdder = async () => {
    const data = { First_Name: firstname, Last_Name: lastname, phone_number: phonenumber, image_path: image_path, Section_ID: sectionid }
    try {
      ...
      <div className="M1-container2">
        <div className="M1-center-container">
          ...
          <div className="M1-addadmins">
            ...
            <input className="M1-input-Addamis" type="text" onChange={(event) => setfirstname(event.target.value)} />
            <label className="M1-label-Addadmins" htmlFor="">Last name</label>
            <input className="M1-input-Addamis" type="text" onChange={(event) => setlastname(event.target.value)} />
            <label className="M1-label-Addadmins" htmlFor="">Phone Number</label>
            <input className="M1-input-Addamis" type="text" onChange={(event) => setphonenumber(event.target.value)} />



          </div>
          <div className="M1-buttons">
            <Link to='/EditSections' className="M1-cancel-classes" state={{ sectionid: state.sectionid }}>Cancel</Link>

            <Link className="M1-edit-classes" onClick={() => studentAdder()} to='/EditSections' state={{ sectionid: state.sectionid }}>Submit</Link>
          </div>
